    ...
    <div class="jumbotron jumbotron-fluid" style="background-color: #ffff">
     ...
     <div class="text-center">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 mt-4">
            ...
            <h3 class="text-success" style="font-weight: bold;">Andhika Saputra</h3>
            <p>Dhika</p>
            <p class="lead">sandhika006@gmail.com</p>
      ...
      <div class="text-center p-3 mt-2" style="background-color: #ffff">
        @copyright Andhika Saputra, all reserved 2021.
      </div>
      </body>
</html>